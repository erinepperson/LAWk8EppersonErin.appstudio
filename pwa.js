...
const cacheName = 'LAWk8ErinEpperson-2021-03-31 21:02:52.139568'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'LAWk8ErinEpperson'.length) === 'LAWk8ErinEpperson') {
